...
The IWiserHomeManager provides operations related to creating home, obtaining the home list and monitoring home status change. It can be obtained by invoking the `WiserHomeSdk.getHomeManagerInstance()`.
